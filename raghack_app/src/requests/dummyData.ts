export const sample_data = {
    ...
    "certificationsPath": [
      {
        "key": 3,
        "reason": "This certification provides a solid foundation in AI and machine learning concepts and Microsoft Azure services, which are critical for developing and deploying predictive models. It introduces fundamental principles and practical skills, setting a strong base for higher-level data science tasks."
      },
      {
        "key": 7,
        "reason": "This certification is directly aligned with the role of a data scientist working on machine learning workloads. Skills in designing, preparing, and deploying machine learning solutions on Azure are essential for analyzing large datasets and building predictive models, as mentioned in the job description."
      },
      {
        "key": 5,
        "reason": "As a data engineer, you will learn to integrate, transform, and consolidate data from various sources to create a suitable schema for analytics solutions. This is crucial for ensuring clean and enhanced datasets for analysis, which supports the data needs and opportunities the role requires."
      },
      {
        "key": 8,
        "reason": "Understanding how to manage and optimize SQL databases is critical for working with large datasets. This certification teaches skills in managing both on-premises and cloud databases, ensuring data platform solutions are secure, high-performing, and reliable."
      },
      {
        "key": 4,
        "reason": "For developing applications that store and manage data in cloud-native environments, this certification offers valuable skills in designing and implementing data models, optimizing solutions, and integrating with other Azure services. These skills are beneficial for managing complex datasets."
      }
    ]
  }

export const defaultResume = `Elixander Chen
1234 Marine Street, Singapore, Singapore, 56789
Email: elixander@live.com | Phone: (123) 456-7890 | LinkedIn: linkedin.com/in/elixander
Objective
Recent Computer Science graduate with strong problem-solving skills and hands-on experience in software development. Seeking an entry-level position to leverage my skills in programming and software engineering.
Education
...
Projects
Portfolio Website
Built a personal portfolio using React to showcase projects and skills.
Task Manager App
Developed a task management application with Node.js and Express for backend and MongoDB for database.
Experience
Intern, Software Developer
Tech Solutions Inc., City, State
June 2023 - August 2023
Assisted in developing and testing new software features.
Contributed to debugging and troubleshooting issues.
Certifications
...
export const defaultJobDescription = `Job Title: Data Scientist
Location: Singapore
Company: Microsoft Singaore
Job Summary:
We are seeking a Data Scientist to join our team and help drive data-driven decision-making. You will analyze large datasets, build predictive models, and provide actionable insights to support business objectives.
